...
export function processReturn(returnId, status) {
  if (status === 'rejected') {
...
export function confirmRejectReturn(returnId) {
...
export function loadReturnItems() {
...
export function submitReturn(e) {
  e.preventDefault();
  const orderId = document.getElementById('return-order').value;
...
/** Filter returns */
export function filterReturns(status, tabEl) {

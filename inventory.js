...
import { formatCurrency, formatDate, isExpiringSoon, generateBarcode } from '../utils.js';
...
export function showAddDrugModal(drugId = null) {
...
export function saveDrug(e, drugId) {
  e.preventDefault();
  const user = store.get('currentUser');
...
export function viewDrug(drugId) {
